// Copied from https://github.com/dengyin2000/dynamic_widget/blob/master/lib/dynamic_widget/utils.dart
...
ShapeBorder? parseShape(Map? map) {
  if (map == null) {
    return null;
  }
  if (map['side'] == null && map['borderRadius'] == null) {
    return null;
  }
...
T? parseEnum<T>(List<T> list, String? value) {
  if (value == null) {
    return null;
  }
  final value0 = '$T.$value';
  return list.firstWhereOrNull((e) => e.toString() == value0);
}

T nonNull<T>(T? object) {
  if (object == null) {
    throw Exception();
  }
  return object;
